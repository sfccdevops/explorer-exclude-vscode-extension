...
const modes = {
  files: {
    ...
    backupKey: 'explorer-exclude-manager.files.backup',
    disabledValuesKey: 'explorer-exclude-manager.files.disabledValues',
  ...
  search: {
    ...
    backupKey: 'explorer-exclude-manager.search.backup',
    disabledValuesKey: 'explorer-exclude-manager.search.disabledValues',
    resetValue: {},
  },
}
